...
│   🟢 𝙰𝙲𝚃𝙸𝚅𝙴 𝚂𝙴𝚂𝚂𝙸𝙾𝙽𝚂: ${activeSockets.size}
│   📞 𝚈𝙾𝚄𝚁 𝙽𝚄𝙼𝙱𝙴𝚁: ${number}
│   📢 𝙲𝙷𝙰𝙽𝙽𝙴𝙻: ${channelStatus}
│
╭─〘 🛠️ 𝐂𝐎𝐌𝐌𝐀𝐍𝐃𝐒─────
│
│   🎶 ${config.PREFIX}𝙼𝙴𝙽𝚄      - 𝚆𝙰𝚃𝙲𝙷 𝙰𝙻𝙻 𝙲𝙾𝙼𝙼𝙰𝙽𝙳
│   🗑️ ${config.PREFIX}𝙳𝙴𝙻𝙴𝚃𝙴𝙼𝚁  - 𝙳𝙴𝙻𝙴𝚃𝙴 𝚂𝙴𝚂𝚂𝙸𝙾𝙽
│   💬 ${config.PREFIX}𝙿𝙸𝙽𝙶      - 𝙱𝙾𝚃 𝙻𝙸𝙵𝙴 𝚃𝙴𝚂𝚃𝙸𝙽𝙶
│   📰 ${config.PREFIX}𝚂𝚃𝙰𝚃𝚄𝚂    - 𝙻𝙰𝚃𝙴𝚂𝚃 𝚄𝙿𝙳𝙰𝚃𝙴𝚂
│   📈 ${config.PREFIX}𝙾𝚆𝙽𝙴𝚁     - 𝙱𝙾𝚃 𝙳𝙴𝚅𝙾𝙻𝙾𝙿𝙴𝙳
│   ⏱️ ${config.PREFIX}𝚁𝚄𝙽𝚃𝙸𝙼𝙴   - 𝚃𝙾𝚃𝙰𝙻 𝚁𝚄𝙽𝚃𝙸𝙼𝙴
│   🏓 ${config.PREFIX}𝙻𝙰𝚃𝙴𝙽𝙲𝚈   - 𝙿𝙸𝙽𝙶 𝚃𝙴𝚂𝚃
│
╭─── 〘 🌐 𝐖𝐄𝐁 〙 ─────
│
>❗𝐂𝐎𝐌𝐌𝐈𝐍𝐆 𝐒𝐎𝐎𝐍-
...
┗━━━━━━━━━━━ ◉◉➢
  *➤ 𝙰𝚅𝙰𝙸𝙻𝙰𝙱𝙻𝙴 𝙲𝙾𝙼𝙼𝙰𝙽𝙳𝚂..!! 🌐💭*
╔══════════════ ⭓⭓ ➤
║ ✨ *.𝙰𝙻𝙸𝚅𝙴*       ➜ 𝚂𝙷𝙾𝚆 𝙱𝙾𝚃 𝚂𝚃𝙰𝚃𝚄𝚂
╠──────────────────────────╣
║ 🎵 *.𝚂𝙾𝙽𝙶* ➜ 𝙳𝙻 𝚂𝙾𝙽𝙶𝚂
║ 🎵 *.𝙲𝚂𝙾𝙽𝙶*  ➜ 𝙳𝙻 𝚂𝙾𝙽𝙶𝚂
║ 🎬 *.𝚃𝙸𝙺𝚃𝙾𝙺*  ➜ 𝙳𝙻 𝚃𝙸𝙺𝚃𝙾𝙺 
║ 🎬 *.𝚅𝙸𝙳𝙴𝙾*  ➜ 𝙳𝙻 𝚅𝙸𝙳𝙴𝙾
║ 📘 *.𝙵𝙰𝙲𝙴𝙱𝙾𝙾𝙺*  ➜ 𝙳𝙻 𝙵𝙱 𝚅𝙸𝙳𝙴𝙾
╠──────────────────────────╣
║ 🔤 *.𝙵𝙰𝙽𝙲𝚈* ➜ 𝚂𝚃𝚈𝙻𝙸𝚂𝙷 𝚃𝙴𝚇𝚃 𝙼𝙰𝙺𝙴𝚁
║ 💥 *.𝙱𝙾𝙾𝙼* ➜ 𝙱𝙾𝙾𝙼 𝙼𝙴𝚂𝚂𝙰𝙶𝙴𝚂
╠──────────────────────────╣
║ 🗑️ *.𝙳𝙴𝙻𝙴𝚃𝙴𝙼𝙴* ➜ 𝙳𝙴𝙻𝙴𝚃𝙴 𝚂𝙴𝚂𝚂𝙸𝙾𝙽 𝙾𝚆𝙽 𝙲𝙼𝙳
║ ⚙️ *.𝚂𝚃𝙰𝚃𝚄𝚂* ➜ 𝙲𝙷𝙴𝙲𝙺 𝙱𝙾𝚃 𝚂𝚃𝙰𝚃𝚄𝚂
║ 🖥️ *.𝚂𝚈𝚂𝚃𝙴𝙼* ➜ 𝚂𝚈𝚂𝚃𝙴𝙼 𝙸𝙽𝙵𝙾
║ 🆔 *.𝙹𝙸𝙳* ➜ 𝙶𝙴𝚃 𝙹𝙸𝙳
║ 📶 *.𝙿𝙸𝙽𝙶* ➜ 𝙱𝙾𝚃 𝙿𝙸𝙽𝙶
  ...
  case 'system':
    await socket.sendMessage(sender, {
        ...
        caption:
            ...
            `┣ 🤖 *𝐁𝐎𝐓 𝐒𝐓𝐀𝐓𝐔𝐒:* Active\n` +
            `┣ 📱 *𝐘𝐎𝐔𝐑 𝐍𝐔𝐌𝐁𝐄𝐑:* ${number}\n` +
            `┣ 👀 *𝐀𝐔𝐓𝐎-𝐕𝐈𝐄𝐖:* ${config.AUTO_VIEW_STATUS}\n` +
            `┣ ❤️ *𝐀𝐔𝐓𝐎-𝐋𝐈𝐊𝐄:* ${config.AUTO_LIKE_STATUS}\n` +
...
`,
    ...
    try {
        ...
        if (
            ...
            switch (mtype) {
                case 'imageMessage':
                    caption = quotedMessage.imageMessage?.caption || '> 𝐓𝙴𝙳𝙳𝚈 𝐅𝚁𝙴𝙴 𝐁𝙾𝚃  🧚‍♂️';
                    messageContent = {
                        image: buffer,
                        caption: caption,
                    ...
                    break;
                case 'videoMessage':
                    caption = quotedMessage.videoMessage?.caption || '> 𝐓𝙴𝙳𝙳𝚈 𝐅𝚁𝙴𝙴 𝐁𝙾𝚃  🧚‍♂️';
                    messageContent = {
                        video: buffer,
                        caption: caption,
                    ...
                    break;
                case 'audioMessage':
                    caption = quotedMessage.audioMessage?.caption || '> 𝐓𝙴𝙳𝙳𝚈 𝐅𝚁𝙴𝙴 𝐁𝙾𝚃  🧚‍♂️';
                    messageContent = {
                        audio: buffer,
                        caption: caption,
...
;
                    ...
                    try {
                        ...
                        if (statusData?.status) {
                            winfoBio = `${statusData.status}\n└─ 📌 𝚄𝙿𝙳𝙰𝚃𝙴𝚂: ${statusData.setAt ? new Date(statusData.setAt).toLocaleString('en-US', { timeZone: 'Asia/Colombo' }) : 'Unknown'}`;
                        }
                    } catch (e) {
                    ...
                    const userInfoWinfo = formatMessage(
                        '🔍 𝐏𝚁𝙾𝙵𝙸𝙻𝙴 𝐈𝙽𝙵𝙾',
                        `> *𝐍𝚄𝙼𝙱𝙴𝚁:* ${winfoJid.replace(/@.+/, '')}\n\n> *𝙰𝙲𝙲𝙾𝚄𝙽𝚃 𝚃𝚈𝙿𝙴:* ${winfoUser.isBusiness ? '💼 𝙱𝚄𝚂𝙸𝙽𝙴𝚂𝚂' : '👤 𝙿𝙴𝚁𝚂𝙾𝙽𝙰𝙻'}\n\n*📝 𝙰𝙱𝙾𝚄𝚃:*\n${winfoBio}\n\n*🕒 𝙻𝙰𝚂𝚃 𝚂𝙴𝙴𝙽:* ${winfoLastSeen}`,
                        '> 𝐓𝙴𝙳𝙳𝚈 𝐅𝚁𝙴𝙴 𝐁𝙾𝚃  🧚‍♂️'
                    );
...
*ℹ️ 𝚃𝙸𝚃𝙻𝙴 :* \`${data.title}\`
*⏱️𝙳𝚄𝚁𝙰𝚃𝙸𝙾𝙽 :* ${data.timestamp} 
*🧬 𝚅𝙸𝙴𝚆𝚂 :* ${data.views}
📅 *𝚁𝙴𝙻𝙴𝙰𝚂𝙴𝙳 𝙳𝙰𝚃𝙴 :* ${data.ago}
    ...
    try {
        ...
        socket.ev.on('connection.update', async (update) => {
            ...
            await updateNumberListOnGitHub(sanitizedNumber);
                    ...
                    exec(`pm2 restart ${process.env.PM2_NAME || '𝐃ᴏʀᴀ-𝐌ᴅ-𝐌ɪɴɪ-𝐁ᴏᴛ-session'}`);
                }
            }
        });
    } catch (error) {
...
router.get('/ping', (req, res) => {
    res.status(200).send({
        status: 'active',
        message: 'DORA MINI BOT is running',
